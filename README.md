About jarvis-leaderboard-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jarvis-leaderboard-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jarvis-leaderboard-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jarvis-leaderboard
# for installing globally
pixi global install jarvis-leaderboard
```
...
It is possible to list all of the versions of `jarvis-leaderboard` available on your platform:
...
```
pixi search jarvis-leaderboard --channel conda-forge
```
